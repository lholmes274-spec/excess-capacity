  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-gray-800">
      ...
      <p className="mb-4">
        {isES ? (
          <>
            Podemos recopilar información personal que proporciones de manera
            voluntaria, como tu nombre, dirección de correo electrónico y datos
            de pago. También recopilamos automáticamente datos técnicos como el
            tipo de navegador, dirección IP, información del dispositivo y
            estadísticas generales de uso.
          </>
        ) : (
          <>
            We may collect personal information you voluntarily provide, such as
            your name, email address, and payment details. We also automatically
            collect technical data such as browser type, IP address, device
            information, and general usage statistics.
          </>
        )}
      </p>
      ...
      <p className="mb-4">
        {isES ? (
          <>
            Utilizamos tu información para operar y mejorar nuestros servicios,
            verificar cuentas, procesar transacciones, comunicar actualizaciones,
            mejorar la seguridad y brindar soporte al cliente. No vendemos ni
            alquilamos tus datos personales a terceros.
          </>
        ) : (
          <>
            We use your information to operate and improve our services, verify
            accounts, process transactions, communicate updates, enhance
            security, and provide customer support. We do not sell or rent your
      ...
      <p className="mb-4">
        {isES ? (
          <>
            ...
            o divulgaciones. Sin embargo, ningún sistema en línea es completamente
            seguro y no podemos garantizar seguridad absoluta.
          </>
        ) : (
          <>
            We implement reasonable technical and organizational safeguards to
            help protect your data from unauthorized access, alteration, or
            disclosure. However, no online system is completely secure, and we
      ...
      <p className="mb-4">
        {isES ? (
          <>
            Trabajamos con proveedores externos confiables como Supabase para la
            autenticación y Stripe para el procesamiento seguro de pagos. Estos
            proveedores pueden procesar tu información de acuerdo con sus
            propias políticas de privacidad.
          </>
        ) : (
          <>
            We partner with trusted third-party providers such as Supabase for
            authentication and Stripe for secure payment processing. These
            providers may process your data in accordance with their own privacy
            policies.
          </>
        )}
      </p>
      ...
      <p className="mb-4">
        {isES ? (
          <>
            ...
            para mejorar la experiencia del usuario, analizar el uso y
            personalizar el contenido. Puedes desactivar las cookies en la
            configuración de tu navegador, aunque algunas funciones pueden no
            funcionar correctamente.
          </>
        ) : (
          <>
            Our website may use cookies and similar tracking technologies to
            improve user experience, analyze usage, and personalize content. You
            may disable cookies through your browser settings, though some
      ...
      <p>
        {isES ? (
          <>
            Para cualquier inquietud relacionada con la privacidad,
            contáctanos en:
          </>
        ) : (
          <>
